...
const ConfirmPayoutModal = ({ isOpen, onClose, payout }) => {
  if (!isOpen || !payout) return null;

  const handleConfirm = () => {
    console.log("Payout confirmed for:", payout.party, payout.netPayout);
    onClose();
  };
    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-[440px] rounded-2xl bg-white shadow-xl p-6">
        ...
        <p className="mt-1 text-sm text-[#667085]">
          ...
          <span className="font-semibold text-[#101828]">{payout.netPayout}</span> to{" "}
          <span className="font-semibold text-[#101828]">{payout.party}</span>.
          <br />
        ...
        <div className="mt-5">
          ...
          <p className="mt-1 text-sm text-[#667085]">xxx 4567</p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <p className="mt-0.5 text-sm text-[#667085]">Bank Transfer</p>
          </div>
        </div>
