...
const statusPill = {
  ...
  Processed: "bg-[#EFF8FF] text-[#175CD3] border border-[#B2DDFF]",
      ...
      <div>
        ...
        <div className="mt-4 rounded-xl border border-[#EAECF0] bg-[#F9FAFB] px-5 py-4 space-y-3">
          ...
          <div className="border-t border-[#EAECF0] pt-3 flex items-center justify-between">
            <span className="text-base font-bold text-[#101828]">Net Impact</span>
            <span className="text-base font-bold text-[#101828]">{d.netImpact}</span>
          </div>
        </div>
