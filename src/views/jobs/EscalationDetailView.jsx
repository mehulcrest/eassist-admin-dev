...
const Label = ({ children }) => (
  <p className="mb-0.5 text-xs font-medium text-[#667085]">{children}</p>
);
          ...
          >
            ...
            {idx < CASE_TIMELINE.length - 1 && (
              <div
                ...
                style={{ width: 0, borderLeft: "2px dashed #D0D5DD", minHeight: 24 }}
              />
            )}
          </div>
          {/* content */}
          <div>
            <span className="text-xs font-semibold text-[#344054]">{item.time}</span>
            <p className="text-xs text-[#475467]">
              {item.label}
              {item.link && (
                <span className="font-semibold text-[#344054] underline underline-offset-2">
                  {item.link}
                </span>
              )}
            </p>
  ...
  <div className="rounded-xl border border-[#EAECF0] bg-white p-5 shadow-sm">
    ...
    <div className="mt-3">
      ...
      <ul className="mt-1 space-y-1">
        {NOTES.map((note, i) => (
          <li key={i} className="flex items-start gap-1.5 text-xs text-[#475467]">
            <span className="mt-1.5 size-[5px] shrink-0 rounded-full bg-[#475467]" />
            {note}
          </li>
        ))}
      </ul>
  ...
  return (
    <div className="flex flex-col gap-6 w-full mx-auto">
      ...
      <div className="flex flex-col lg:flex-row items-start gap-6">
        {/* ═══ LEFT MAIN CARD ═══ */}
        <div className="flex flex-1 flex-col gap-6 rounded-xl border border-[#EAECF0] bg-white py-6 shadow-sm min-w-0 w-full lg:w-auto">

      {/* ── Back header ── */}
      <div className="flex items-center gap-3 border-b border-[#EAECF0] bg-white px-6 py-4 shrink-0">
        <button
          type="button"
          onClick={onBack}
            ...
            <div className="mt-4 px-6 sm:px-0 grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4">
              <div>
                ...
                <span className={`mt-1 inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold ${
                  row.severity === "High"   ? "bg-red-50 text-red-500" :
        ...
        <div className="flex w-full lg:w-[340px] shrink-0 flex-col gap-6">
          ...
          <div className="rounded-xl border border-[#EAECF0] bg-white p-5 shadow-sm">
            ...
            <div className="mt-3 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-center gap-2.5">
                ...
                <button type="button" className="text-sm font-semibold text-[#344054] underline underline-offset-2 hover:text-[#F04438] transition-colors">
                  Margaret Thompson
                </button>
              </div>
          ...
          <div className="rounded-xl border border-[#EAECF0] bg-white p-5 shadow-sm">
            <SectionTitle>PSP Information</SectionTitle>
            <div className="mt-3 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-center gap-2.5">
                <img src={userProfile} alt="" className="size-8 rounded-full object-cover ring-1 ring-[#EAECF0]" />
                <button type="button" className="text-sm font-semibold text-[#344054] underline underline-offset-2 hover:text-[#F04438] transition-colors">
      ...
      <div className="rounded-xl border border-[#EAECF0] bg-white px-6 py-6 shadow-sm">
          <div>
      ...
      <div className="rounded-xl border border-[#EAECF0] bg-white px-6 py-6 shadow-sm">
        <SectionTitle>Resolution</SectionTitle>
                ...
                return (
                  ...
                  >
                    ...
                    <span className={`flex size-4 shrink-0 items-center justify-center rounded-full border ${
                      isSelected ? "border-[#F04438]" : "border-[#D0D5DD]"
                    }`}>
                      {isSelected && (
          ...
          {/* ── Action buttons ── */}
          <div className="mt-6 flex flex-col sm:flex-row items-center justify-end gap-3 border-t border-[#EAECF0] pt-6">
            <button
              type="button"
            ...
            >
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M13.3 4.3L6 11.6 2.7 8.3" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
              Resolved Case
            </button>
          </div>
