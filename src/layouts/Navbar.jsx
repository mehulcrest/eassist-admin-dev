...
const Navbar = () => {
  ...
  return (
    <header className="sticky top-0 z-20 flex min-h-[72px] items-center gap-4 border-b border-[#EAECF0] bg-white px-6 py-4">
      {isAddMemberPage ? (
        ...
        <div className="shrink-0 text-lg">
          ...
          <span className="px-1 text-[#667085]">|</span>
          <span className="font-semibold text-[#101828]">{memberName}</span>
        </div>
      ) : (
        <h2 className="shrink-0 text-xl font-semibold text-[#101828]">
          {pageTitle}
        </h2>
      )}
      ...
      <div className="ml-auto flex shrink-0 items-center gap-3">
        ...
        >
            ...
            <circle cx="37" cy="7" r="5" fill="#FD853A" stroke="white" stroke-width="2"/>
        ...
        <div className="flex h-9 items-center gap-2.5 rounded-xl px-3 pr-2.5">
          <div className="h-11 w-11 overflow-hidden rounded-xl border border-textColor/20">
          ...
          <div>
              ...
              <p className="text-sm text-normal text-textColor/70">Admin</p>
            </div>
            <ChevronDown className="text-icon" size={14} />
        </div>
      </div>
    </header>
  );
